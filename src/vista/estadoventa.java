 ...
 * @author usuario
 */
public class estadoventa extends javax.swing.JFrame {

    /** Creates new form estadoventa */
    public estadoventa() {
        initComponents();
        Controlador.estadoventaController.dataRows(tablaestado);
    ...
    private void initComponents() {
        ...
        btnlimpiar.setPreferredSize(new java.awt.Dimension(105, 32));
        ...
        labelCategoriaArt.setText("Estado de Venta:");
        ...
        jLabel3.setText("Estado de Ventas");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        // TODO add your handling code here:
        Controlador.estadoventaController.btnAgregar(txtestado.getText(),seleccionEstado.getSelectedIndex());
        Controlador.estadoventaController.dataRows(tablaestado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estadoventa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estadoventa().setVisible(true);
            }
        });
    }
