...
public class Packs extends javax.swing.JFrame {
    ...
    public Packs() {
        ...
        modelo.addColumn ("precio pack");
        modelo.addColumn ("articulos pack");
        modelo.addColumn ("estado pack");
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dia de la Madre", "Dia del Padre", "Dia de los pololos", "Aniversario bodas", "Dia del niño" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9" }));

        jLabel2.setText("Código pack:");

        jLabel3.setText("Precio Pack:");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "8.990", "14.990", "18.990", "28.990", "35.990", "38.990" }));

        jLabel4.setText("Articulos pack:");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Datos[0]=jComboBox2.getSelectedItem().toString();
        Datos[1]=jComboBox3.getSelectedItem().toString();
        Datos[2]=jComboBox4.getSelectedItem().toString();
        Datos[3]=jComboBox5.getSelectedItem().toString();
